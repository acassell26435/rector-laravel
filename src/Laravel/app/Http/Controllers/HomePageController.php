...
class HomePageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::check()) {
            ...
            $data = ['name' => $user_name, 'email' => $user_email, 'washing_plan' => $washing_plan, 'vehicle_company' => $vehicle_company, 'vehicle_modal' => $vehicle_modal, 'vehicle_type' => $vehicle_type, 'date' => $appointment_date, 'time_frame' => $time_frame];
